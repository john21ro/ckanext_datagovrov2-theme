...
class TestDatagovrov2Theme(helpers.FunctionalTestBase):
    @classmethod
    def setup_class(cls):
        cls.app = paste.fixture.TestApp(pylons.test.pylonsapp)
        ckan.plugins.load('datagovrov2_theme')

    def setup(self):
        super(Testdatagovrov2Theme, self).setup()
    ...
    def teardown_class(cls):
        ckan.plugins.unload('datagovrov2_theme')
